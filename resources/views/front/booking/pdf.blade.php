                ...
                <td>
                    <div class="box">
                        ...
                        <div class="item">
                            ...
                            <span class="value">{{ $booking->business_name ?: 'Non renseigné' }}</span>
                        </div>
                        @endif
                    </div>
                </td>
                ...
                <td>
                    <div class="box">
                        ...
                        <div class="item">
                            ...
                            <span class="value">{{ $booking->service_type === 'event' ? 'Événement' : 'Publicité' }}</span>
                        </div>
                        ...
                        <div class="item">
                            ...
                            <span class="value">{{ $booking->budget ? number_format((float) $booking->budget) . ' DA' : 'À confirmer' }}</span>
                        </div>

                        <div class="item">
                            <span class="label">Date souhaitée</span>
                            <span class="value">{{ $booking->deadline ?: 'À confirmer' }}</span>
                        </div>
                        @endif
                    </div>
                </td>
