...
<div class="card db-card">
    ...
    <div class="card-body db-card-body">
        <div class="table-responsive">
            <table class="table table-bordered table-striped table-hover datatable datatable-Role db-table text-center">
                <thead>
                    <tr>
                        <th width="10">
                        ...
                        <tr data-entry-id="{{ $role->id }}">
                            ...
                            <td>
                                <div class="db-actions">
                                    ...
                                    @endcan
                                    @can('role_delete')
                                        <form action="{{ route('admin.roles.destroy', $role->id) }}" method="POST" class="d-inline" onsubmit="return confirm('{{ trans('global.areYouSure') }}');">
                                            @csrf
                                            @method('DELETE')
