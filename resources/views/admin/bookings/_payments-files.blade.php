...
<div class="card db-card mb-4">
    <div class="card-header db-card-header db-card-header-toggle d-flex justify-content-between align-items-center" data-toggle="collapse" data-target="#collapse-payments" role="button" aria-expanded="true">
    ...
    <div id="collapse-payments" class="card-body db-card-body collapse show">
        ...
        <form action="{{ route('admin.bookings.payments.update-total', $booking->id) }}" method="POST" class="mb-4">
            ...
            <div class="row g-2 align-items-end">
                <div class="col-md-4">
                    ...
                    <input type="number" name="total_price" class="form-control db-input"
                           value="{{ $booking->total_price }}" min="0" step="100"
                           placeholder="مثال: 35000">
                </div>
                <div class="col-md-2">
                    <button type="submit" class="btn db-btn-primary w-100">
                ...
                <tr>
                    ...
                    <td>
                        <form action="{{ route('admin.bookings.payments.destroy', $pay->id) }}" method="POST"
                            ...
                            @csrf @method('DELETE')
                            <button class="btn btn-sm db-icon-btn db-delete-btn" type="submit">
            ...
            <form action="{{ route('admin.bookings.payments.store') }}" method="POST">
                ...
                <div class="row g-2">
                    <div class="col-md-3">
                        ...
                        <input type="number" name="amount" class="form-control db-input" min="1" step="1" required>
                    </div>
                    <div class="col-md-2">
                    ...
                    <div class="col-md-2">
                        ...
                        <select name="method" class="form-control db-input">
                    ...
                    <div class="col-md-2">
                        ...
                        <input type="text" name="reference" class="form-control db-input" placeholder="اختياري">
                    </div>
                    <div class="col-md-2">
                        <label class="db-label">تاريخ الدفع</label>
                        <input type="date" name="paid_at" class="form-control db-input"
                               value="{{ now()->format('Y-m-d') }}" required>
                    </div>
                    <div class="col-md-1 d-flex align-items-end">
                        <button type="submit" class="btn db-btn-success w-100">
                ...
                <div class="row mt-2">
                    <div class="col-md-8">
                        <input type="text" name="notes" class="form-control db-input"
...
{{-- ───── FILES SECTION ─────────────────────────────────── --}}
<div class="card db-card mb-4">
    <div class="card-header db-card-header db-card-header-toggle d-flex justify-content-between align-items-center" data-toggle="collapse" data-target="#collapse-files" role="button" aria-expanded="true">
        <span><i class="bi bi-folder2-open me-2"></i> ملفات المشروع</span>
        <span class="d-flex align-items-center gap-2">
            <span class="badge badge-secondary">{{ $booking->files->count() }} ملف</span>
            <i class="fas fa-chevron-down db-collapse-icon"></i>
        </span>
    </div>
    <div id="collapse-files" class="card-body db-card-body collapse show">
        ...
        <div style="background:#f0f9ff;border:1px solid #bae6fd;border-radius:16px;padding:18px;margin-bottom:20px;">
            ...
            <form action="{{ route('admin.bookings.finalVideo', $booking) }}" method="POST" class="row g-2 align-items-end">
                @csrf
                @method('PATCH')
                <div class="col-md-8">
                    <input type="text" name="final_video_path" value="{{ $booking->final_video_path }}"
                           placeholder="رابط فيديو أو مسار الملف" class="form-control db-input">
                </div>
                <div class="col-md-2">
                    <button type="submit" class="btn db-btn-primary w-100">
                        <i class="bi bi-check2"></i> حفظ
            ...
            <form action="{{ route('admin.bookings.files.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row g-2">
                    <div class="col-md-4">
                        ...
                        <input type="text" name="label" class="form-control db-input"
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="file" name="file" class="form-control db-input" required>
                    </div>
                    <div class="col-md-1">
