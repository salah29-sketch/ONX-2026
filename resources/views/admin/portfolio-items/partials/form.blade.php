        ...
        <div class="row g-4">
            <div class="col-md-6">
                ...
                <input
                    ...
                    value="{{ old('title', optional($portfolioItem)->title ?? '') }}"
                    required
                >
            </div>
            ...
            <div class="col-md-3">
                ...
                <select name="service_type" class="form-control pf-input">
                    <option value="">—</option>
                    <option value="event" {{ old('service_type', optional($portfolioItem)->service_type ?? '') === 'event' ? 'selected' : '' }}>
                        حفلات
                    </option>
                    <option value="ads" {{ old('service_type', optional($portfolioItem)->service_type ?? '') === 'ads' ? 'selected' : '' }}>
                        إعلانات
                    </option>
                </select>
            </div>
            ...
            <div class="col-md-3">
                ...
                <input
                    ...
                    name="category"
                    class="form-control pf-input"
                    value="{{ old('category', optional($portfolioItem)->category ?? '') }}"
            ...
            <div class="col-md-6">
                ...
                <input
                    ...
                    name="caption"
                    class="form-control pf-input"
                    value="{{ old('caption', optional($portfolioItem)->caption ?? '') }}"
                >
            </div>
            ...
            <div class="col-md-3">
                ...
                <input
                    ...
                    name="client_name"
                    class="form-control pf-input"
                    value="{{ old('client_name', optional($portfolioItem)->client_name ?? '') }}"
                >
            </div>
            ...
            <div class="col-md-3">
                ...
                <input
                    ...
                    name="location_name"
                    class="form-control pf-input"
                    value="{{ old('location_name', optional($portfolioItem)->location_name ?? '') }}"
                >
            </div>
            ...
            <div class="col-12">
                ...
                >{{ old('description', optional($portfolioItem)->description ?? '') }}</textarea>
            </div>
        </div>
    </section>
            ...
            <div class="col-md-8 media-field media-image">
                ...
                <div class="pf-upload-card">
                    ...
                    <div
                        ...
                        class="pf-image-preview-wrapper {{ !empty(optional($portfolioItem)->image_path) ? '' : 'd-none' }}"
                    >
                        <div class="pf-preview-head">معاينة الصورة</div>

                        <img
                            id="image-preview"
                            src="{{ !empty(optional($portfolioItem)->image_path) ? asset(optional($portfolioItem)->image_path) : '' }}"
                            alt="preview"
