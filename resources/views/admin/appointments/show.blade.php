        ...
        <div class="mb-2">
            <table class="table table-bordered table-striped">
                <tbody>
                    ...
                    <tr>
                         <th>
                            {{ trans('cruds.appointment.fields.event_location') }}
                        </th>
                        <td>
                            {{$appointment->eventLocation->name.' - '.$appointment->eventLocation->address  }}
                        </td>
                    </tr>
                    <tr>
                        <th>
                    ...
                    <tr>
                        ...
                        <td>
                            {{ $appointment->price }} Dzd
                        </td>
                    </tr>
                     <tr>
                        <th>
                             {{ trans('cruds.appointment.fields.deposit') }}
                        </th>
                        <td>
                             {{ $appointment->deposit }} Dzd
                        </td>
                    </tr>
                    <tr>
                        <th>
