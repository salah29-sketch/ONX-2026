...
class ForgotPasswordController extends Controller
{
    ...
    public function sendOtp(Request $request)
    {
        ...
        if ($client) {
            // التحقق من وجود بريد إلكتروني لإرسال OTP
            if (!$client->email) {
                return response()->json([
                    'success' => false,
            ...
            // نستخدم بريد العميل الفعلي لتخزين OTP
            ...
            try {
                ...
                // لا نكشف سبب الفشل في الإنتاج
            }

            // نخزن البريد الفعلي للعميل في الـ session
    ...
    // POST /client/forgot-password/verify — التحقق من صحة الكود فقط (لا تغيير كلمة المرور)
